...
test('Full comment insertion', async () => {
    const fields = new Fields([
        Field.FromDb('id', 'INTEGER'),
        Field.FromDb('db_name', 'INTEGER')
    ])
    ...
    const textBefore = `import { registerModel } from 'semla'

export class Instrument {`

    const textAfter = `import { registerModel } from 'semla'
...
test('Full comment replacement', async () => {
    const fields = new Fields([
        Field.FromDb('id', 'INTEGER'),
        Field.FromDb('db_name', 'INTEGER')
    ])
